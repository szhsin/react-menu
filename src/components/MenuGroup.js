...
import { defineName, menuClass, menuGroupClass, stylePropTypes, MenuListContext } from '../utils';

export const MenuGroup = defineName(
  forwardRef(function MenuGroup({ className, styles, takeOverflow, ...restProps }, externalRef) {
