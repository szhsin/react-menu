...
var placeArrowHorizontal = require('./placeArrowHorizontal.cjs');
...
const placeToporBottom = ({
  ...
  const arrowX = arrow ? placeArrowHorizontal.placeArrowHorizontal({
    menuX: x,
    arrowRef,
    anchorRect,
    containerRect,
...
exports.placeToporBottom = placeToporBottom;
